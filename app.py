...
# created 11/06/2022                                                #
#                                                                   #
# This project to to provide an example of the type of data         #
# dashboards I am able to create to aid business decision making.   #
#                                                                   #
# All data used is simulated and was taken from                     #
# https://www.kaggle.com/datasets/knightbearr/sales-product-data    #
#                                                                   #
# If you would like to contact me about this project then my        #
# linkedin profile is https://www.linkedin.com/in/keithcooper1984/  #
#####################################################################
# Libraries
import dash
...
# Data previously cleaned by combining csv files, correcting data types (dates) 
# and creating new columns. Jupyter notebook for this is available on my github
...
# Plotly express used for choropleth to reduce libraries used - original was in folium
...
def group_products_time(dataframe, time_type):
    ...
    """
    # hour not currently used in app
...
# Create individual KPI Chart - used by KPI graphs callback
...
def render_content(tab):
    if tab == 'tab-KPI':
        return html.Div([
            ...
            html.P('Actual Figures are in blue, target is the border between green and red, amount above or below target is shown underneath.'),
            html.P('Select desired month (or total for the year) from the blue drop down box'),  
        ...
        return html.Div([
            ...
            html.P('Select to view data by month or by day from the blue drop down box'), 
        ...
        return html.Div([
            ...
            html.P('Click on product to include / exclude it. Double click to view only that item'),
            html.P('Select to view either revenue or unit sales from the blue drop down box'), 
...
# Chart for Product Sales by State tab
...
# Chart for 'Sales by Time Interval' tab
...
# 3 * chart for 'Key Performace Indicators 2019' tab
@app.callback(
